...
public class FilesParser {
	...
	private boolean checkSimulationProperties(String simProp) {
		...
		try {
			...
			if (prop.getProperty("random_seed") != null) {
				simulationParameters.RANDOM_SEED = Long.parseLong(prop.getProperty("random_seed").trim());
			}
			simulationParameters.resetRandomGenerator();
			...
			if (prop.getProperty("speed") != null) {
				simulationParameters.VEHICLE_SPEED = Double.parseDouble(prop.getProperty("speed").trim());
			}
			if (prop.getProperty("satellite_speed") != null) {
				simulationParameters.SATELLITE_SPEED = Double.parseDouble(prop.getProperty("satellite_speed").trim());
			}
			if (System.getProperty("vehicle.speed") != null) {
				simulationParameters.VEHICLE_SPEED = Double.parseDouble(System.getProperty("vehicle.speed").trim());
			}
			if (System.getProperty("satellite.speed") != null) {
				simulationParameters.SATELLITE_SPEED = Double.parseDouble(System.getProperty("satellite.speed").trim());
			}
