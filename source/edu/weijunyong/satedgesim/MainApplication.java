...
public class MainApplication {
	...
	public static void main(String[] args) {
		configureScenarioFiles(args);
		launchSimulation();
	}

	private static void configureScenarioFiles(String[] args) {
		if (args == null || args.length == 0) {
			return;
		}
		for (String arg : args) {
			if ("chapter3".equalsIgnoreCase(arg) || "--chapter3".equalsIgnoreCase(arg)) {
				simConfigfile = "SatEdgeSim/settings/simulation_parameters.properties";
				applicationsFile = "SatEdgeSim/settings/applications.xml";
				outputFolder = "SatEdgeSim/output/chapter3/";
			}
			if ("chapter4".equalsIgnoreCase(arg) || "--chapter4".equalsIgnoreCase(arg)) {
				simConfigfile = "SatEdgeSim/settings/chapter4_simulation_parameters.properties";
				applicationsFile = "SatEdgeSim/settings/chapter4_applications.xml";
				outputFolder = "SatEdgeSim/output/chapter4/";
			}
		}
	}
